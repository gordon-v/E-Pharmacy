                ...
                <div class="slider-container has-scrollbar">
                    ...
                    while ($row = mysqli_fetch_assoc($banner_products)) {
                        ...
                        <div class="slider-item">
                            <img src="images/carousel/<?php echo $row['banner_image']; ?>"
                            ...
                            <div class="banner-content">
                                ...
                                <?php if ($banner_items_price > 0): ?>
                                    <p class="banner-text">starting at &dollar;
                                        <b><?php echo $banner_items_price; ?></b>.00</p>
                    ...
                    while ($row = mysqli_fetch_assoc($catgeory_bar_products)) {
                        ...
                        <div class="category-item">
                            <div class="category-img-box">
                                <img src="./images/side_bar_icons/<?php echo $row['category_img'] ?>" alt="category bar img"
                                     width="30"/>
                            </div>
                            ...
                            <div class="category-content-box">
                                ...
                                <a href="category.php?category=<?php echo urlencode($row['category_title']); ?>"
                                   class="category-link">
            ...
            <div class="container">
                ...
                <div class="product-box">
                                        ...
                                        <div class="showcase">
                                            <a href="./viewdetail.php?id=<?php echo $row1['product_id'] ?>&category=<?php echo $row1['category_id'] ?>"
                                               class="showcase-img-box">
                                                <img src="./images/<?php echo $row1['product_img']; ?>"
                                        ...
                                        if ($row2['product_id'] > $itemID) {
                                            ...
                                            <div class="showcase">
                                                <a href="./viewdetail.php?id=<?php echo $row2['product_id'] ?>&category=<?php echo $row2['category_id'] ?>"
                                                   class="showcase-img-box">
                                                    <img src="./images/<?php echo $row2['product_img']; ?>"
                                    ...
                                    while ($row1 = mysqli_fetch_assoc($trending_products1)) {
                                        ...
                                        <div class="showcase">
                                            <a href="./viewdetail.php?id=<?php echo $row1['product_id'] ?>&category=<?php echo $row1['category_id'] ?>"
                                               class="showcase-img-box">
                                                <img src="./images/<?php echo $row1['product_img']; ?>"
                                                     alt="Treding products image" width="70" class="showcase-img"/>
                                            </a>
                    ...
                    <div class="product-main">
                        <h2 class="title">Нови продукти</h2>
                ...
                <div class="testimonials-box">
                    ...
                    <div class="testimonial">
                        ...
                        <div class="testimonial-card">
                            <img src="./images/testimonial-1 copy.jpg" alt="alan doe" class="testimonial-banner"
                                 width="80" height="80"/>
                    ...
                    <div class="service">
                        <h2 class="title">Наши сервиси</h2>
                        ...
                        <div class="service-container">
                            <a href="#" class="service-item">
                                ...
                                <div class="service-content">
                                    <h3 class="service-title">Достава до дома</h3>
                                    <p class="service-desc">за нарачки над 1500 денари</p>
                                </div>
                            </a>
                            ...
                            <a href="#" class="service-item">
                                ...
                                <div class="service-content">
                                    <h3 class="service-title">Брза достава</h3>
                                    <p class="service-desc">Низ цела македонија</p>
                                </div>
                            </a>
                            ...
                            <a href="#" class="service-item">
                                ...
                                <div class="service-content">
                                    <h3 class="service-title">Најдобрата онлајн-подршка</h3>
                            ...
                            <a href="#" class="service-item">
                                ...
                                <div class="service-content">
                                    <h3 class="service-title">Најголем избор на лекови</h3>
                                    <p class="service-desc">и медицински материјали</p>
                                </div>
                            </a>
                            ...
                            <a href="#" class="service-item">
                                ...
                                <div class="service-content">
                                    <h3 class="service-title">Лекови на рецепт</h3>
